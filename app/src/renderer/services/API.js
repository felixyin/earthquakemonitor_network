...
// const BaseUrl = 'http://localhost:8080' // for local poxy

const BaseUrl = config.server // for local mock test

export const LOGIN = BaseUrl + '/user/login' // 登录
export const REGIST = BaseUrl + '/register' // 注册

export const FIND_ALL_DEPLOY_POINT = BaseUrl + '/deployPoint/findAll' // 返回所有部署点
export const FIND_ALL_EARLY_WARNING_INTENSITY = BaseUrl + '/earthquakeYuJing/findAll' // 返回所有震源
export const FIND_ALL_USER = BaseUrl + '/user/findAll' // 返回所有的用户
export const SAVE_USER = BaseUrl + '/user/save' // 返回所有的用户
export const DELETE_USER = BaseUrl + '/user/delete' // 删除用户

export const GET_REGIONS = BaseUrl + '/acquire_campus' // 获取校区
